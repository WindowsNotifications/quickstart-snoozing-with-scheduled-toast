using QuickstartSnoozingWithScheduledToast.Helpers;
using System;
...
namespace QuickstartSnoozingWithScheduledToast
{
    /// <summary>
    ...
    sealed partial class App : Application
    {
        ...
        private async void OnLaunchedOrActivated(IActivatedEventArgs e)
        {
            try
            {
                ...
                await ToastHelper.RegisterBackgroundTaskAsync();
        ...
        protected override void OnBackgroundActivated(BackgroundActivatedEventArgs args)
        {
            try
            {
                ...
                {
                    case ToastHelper.TOAST_BACKGROUND_TASK:
                        ToastHelper.HandleBackgroundActivation((ToastNotificationActionTriggerDetail)args.TaskInstance.TriggerDetails);
                        break;
                }
